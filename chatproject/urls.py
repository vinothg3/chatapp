...
urlpatterns = [
    ...
    path('^(?P<pk>\d+)/',views.message,name='message'),
    ...
    path('^(?p<pk>\d+)/',views.forward,name='forward'),
    path('(?p<y>\d+)$/',views.delete,name='delete'),
    path('status/',status,name='status'),
    path('(?P<id>\d+)$/',views.req_status,name='req_status'),
    path('ok/',ok,name='ok'),
